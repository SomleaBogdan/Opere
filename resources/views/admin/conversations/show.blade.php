...
<div class="container" style="margin-top: 25px;">
    <div class="row" style="height:100px;">
        ...
        <div class="card">
                <div class="card-header">{{$conversation->titlu_mesaj}}</div>
                <div class="card-body">
                    @isset($conversation) 
                ...
                <div class="card-body">
                    ...
                    @endisset
                    <input id="" name="titlu_mesaj" type="hidden" value="{{$conversation->titlu_mesaj}}">
                    <input name="id_expeditor" type="hidden" value="{{Auth::id()}}">
                    <input name="id_destinatar" type="hidden" value="{{$conversation->expeditor->id}}">
