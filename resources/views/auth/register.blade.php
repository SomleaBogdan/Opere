                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="prenume" type="text" class="form-control" name="prenume" required autofocus>
                            </div>
                        </div>

                        <div class="form-group row">
                            <label for="nr_matricol" class="col-md-4 col-form-label text-md-right">Nr. Matricol</label>
                            <div class="col-md-6">
                                <input id="nr_matricol" type="text" class="form-control" name="nr_matricol" required autofocus>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="telefon" type="text" class="form-control" name="telefon" required autofocus>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <div class="col-md-10">
                                <button type="submit" class="btn btn-primary float-right">Inregistrare</button>
                            </div>
                        </div>
                    </form>
                </div>
